...
_base_ = [
    f"{mmdet_base}/models/faster_rcnn_r50_fpn_double.py",
...
evaluation = dict(type="SubModulesDistEvalHook", interval=180001)
optimizer = dict(type="SGD", lr=0.01, momentum=0.9, weight_decay=0.0001)
lr_config = dict(step=[120000, 160000])
runner = dict(_delete_=True, type="IterBasedRunner", max_iters=180000)
checkpoint_config = dict(by_epoch=False, interval=20000, max_keep_ckpts=20)

...
def policy_custom():
    ...
    policy = [
        [('Equalize', 0.8, 2)],#[('TranslateX_BBox', 0.6, 3), ('Equalize', 0.8, 2)],
        [('Cutout', 0.8, 4), ('Color', 0.5, 3)],
        [('Sharpness', 0.6, 5)],#[('Sharpness', 0.6, 5), ('ShearX_BBox', 0.4, 1)],
        # [('ShearY_BBox', 0.4, 2), ('Equalize_Only_BBoxes', 0.6, 2)],
        [('SolarizeAdd', 0.6, 1), ('Brightness', 0.8, 3)],
        [('Cutout', 0.8, 5)],#[('TranslateY_Only_BBoxes', 0.2, 1), ('Cutout', 0.8, 5)],
...
def policy_v0():
    ...
    # sub-policy that will be applied sequentially on the image.
    policy = [
        [('Equalize', 0.8, 10)],#[('TranslateX_BBox', 0.6, 4), ('Equalize', 0.8, 10)],
        [('Cutout', 0.8, 8)],#[('TranslateY_Only_BBoxes', 0.2, 2), ('Cutout', 0.8, 8)],
        [('Sharpness', 0.0, 8)],#[('Sharpness', 0.0, 8), ('ShearX_BBox', 0.4, 0)],
        # [('ShearY_BBox', 1.0, 2), ('TranslateY_Only_BBoxes', 0.6, 6)],
        [('Color', 1.0, 6)],#[('Rotate_BBox', 0.6, 10), ('Color', 1.0, 6)],
    ]
    return policy
...
def policy_v1():
    ...
    policy = [
        ...
        # [('ShearY_BBox', 1.0, 2), ('TranslateY_Only_BBoxes', 0.6, 6)],
        [('Color', 1.0, 6)],#[('Rotate_BBox', 0.6, 10), ('Color', 1.0, 6)],
        [('Color', 0.0, 0)],#[('Color', 0.0, 0), ('ShearX_Only_BBoxes', 0.8, 4)],
        # [('ShearY_Only_BBoxes', 0.8, 2), ('Flip_Only_BBoxes', 0.0, 10)],
        [('Equalize', 0.6, 10)],#[('Equalize', 0.6, 10), ('TranslateX_BBox', 0.2, 2)],
        [('Color', 1.0, 10)],#[('Color', 1.0, 10), ('TranslateY_Only_BBoxes', 0.4, 6)],
        [('Contrast', 0.0, 10)],#[('Rotate_BBox', 0.8, 10), ('Contrast', 0.0, 10)],
        [('Cutout', 0.2, 2), ('Brightness', 0.8, 10)],
        [('Color', 1.0, 6), ('Equalize', 1.0, 2)],
        # [('Cutout_Only_BBoxes', 0.4, 6), ('TranslateY_Only_BBoxes', 0.8, 2)],
        [('Color', 0.2, 8)],#[('Color', 0.2, 8), ('Rotate_BBox', 0.8, 10)],
        [('Sharpness', 0.4, 4)],#[('Sharpness', 0.4, 4), ('TranslateY_Only_BBoxes', 0.0, 4)],
        [('Sharpness', 1.0, 4), ('SolarizeAdd', 0.4, 4)],
        [('Sharpness', 0.2, 8)],#[('Rotate_BBox', 1.0, 8), ('Sharpness', 0.2, 8)],
...
def policy_v2():
    ...
    policy = [
        ...
        [('Sharpness', 0.4, 2)],#[('Rotate_BBox', 0.4, 8), ('Sharpness', 0.4, 2), ('Rotate_BBox', 0.8, 10)],
        [('AutoContrast', 0.8, 2)],#[('TranslateY_BBox', 1.0, 8), ('AutoContrast', 0.8, 2)],
        [('AutoContrast', 0.4, 6), ('Brightness', 0.0, 10)],#[('AutoContrast', 0.4, 6), ('ShearX_BBox', 0.8, 8), ('Brightness', 0.0, 10)],
        [('SolarizeAdd', 0.2, 6), ('Contrast', 0.0, 10), ('AutoContrast', 0.6, 0)],
        [('Cutout', 0.2, 0), ('Solarize', 0.8, 8), ('Color', 1.0, 4)],
        [('Equalize', 0.6, 8), ('Solarize', 0.0, 10)],#[('TranslateY_BBox', 0.0, 4), ('Equalize', 0.6, 8), ('Solarize', 0.0, 10)],
        # [('TranslateY_BBox', 0.2, 2), ('ShearY_BBox', 0.8, 8), ('Rotate_BBox', 0.8, 8)],
        [('Cutout', 0.8, 8), ('Brightness', 0.8, 8), ('Cutout', 0.2, 2)],
        [('Color', 0.8, 4)],#[('Color', 0.8, 4), ('TranslateY_BBox', 1.0, 6), ('Rotate_BBox', 0.6, 6)],
        [('Cutout', 0.2, 8)],#[('Rotate_BBox', 0.6, 10), ('BBox_Cutout', 1.0, 4), ('Cutout', 0.2, 8)],
        [('Equalize', 0.6, 6)],#[('Rotate_BBox', 0.0, 0), ('Equalize', 0.6, 6), ('ShearY_BBox', 0.6, 8)],
        [('Brightness', 0.8, 8), ('AutoContrast', 0.4, 2), ('Brightness', 0.2, 2)],
        [('Solarize', 0.4, 6), ('SolarizeAdd', 0.2, 10)],#[('TranslateY_BBox', 0.4, 8), ('Solarize', 0.4, 6), ('SolarizeAdd', 0.2, 10)],
...
def policy_v3():
    ...
    # sub-policy that will be applied sequentially on the image.
    policy = [
        [('Posterize', 0.8, 2)],#[('Posterize', 0.8, 2), ('TranslateX_BBox', 1.0, 8)],
        [('Sharpness', 1.0, 8)],  #[('BBox_Cutout', 0.2, 10), ('Sharpness', 1.0, 8)],
        # [('Rotate_BBox', 0.6, 8), ('Rotate_BBox', 0.8, 10)],
        [('Equalize', 0.8, 10), ('AutoContrast', 0.2, 10)],
        [('SolarizeAdd', 0.2, 2)],#[('SolarizeAdd', 0.2, 2), ('TranslateY_BBox', 0.2, 8)],
        [('Sharpness', 0.0, 2), ('Color', 0.4, 8)],
        [('Equalize', 1.0, 8)],#[('Equalize', 1.0, 8), ('TranslateY_BBox', 1.0, 8)],
        [('Posterize', 0.6, 2)],#[('Posterize', 0.6, 2), ('Rotate_BBox', 0.0, 10)],
        [('AutoContrast', 0.6, 0)],#[('AutoContrast', 0.6, 0), ('Rotate_BBox', 1.0, 6)],
        [('Equalize', 0.0, 4), ('Cutout', 0.8, 10)],
        [('Brightness', 1.0, 2)],#[('Brightness', 1.0, 2), ('TranslateY_BBox', 1.0, 6)],
        [('Contrast', 0.0, 2)],#[('Contrast', 0.0, 2), ('ShearY_BBox', 0.8, 0)],
        [('AutoContrast', 0.8, 10), ('Contrast', 0.2, 10)],
        [('Cutout', 1.0, 10)],#[('Rotate_BBox', 1.0, 10), ('Cutout', 1.0, 10)],

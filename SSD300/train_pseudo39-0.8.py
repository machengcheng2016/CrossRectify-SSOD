            ...
            for i_unsup in range(len(unsup_image_index)):
                ...
                if mask_val_fg.sum() > 0:
                    ...
                    if mask_pseudo.sum() > 0:
                        ...
                        anchor_label_unsup_i = match(target_unsup, priors_single)
                        ...
                        loss_c_unsup += F.cross_entropy(conf_data_unsup_i_selected, conf_data_unsup_i_selected.argmax(dim=-1), size_average=False, reduce=False).sum(-1)
